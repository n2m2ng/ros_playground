...
public:
     ...
     */
    KyunController(std::string action_name) :
        action_name_(action_name),
        as_(nh_, action_name, boost::bind(&KyunController::executeCb, this, _1), false)
    {
        as_.start();
        ...
        auto local_pos_cb = boost::bind(&kyunController::localPosCb, this, _1);
        ...
        auto state_cb = boost::bind(&KyunController::stateCb, this, _1);
...
{
    ros::init(argv, argc, "kyun_controller");

    KyunController controller("iris_group_controller/follow_multi_dof_joint_trajectory");
    ros::spin();
